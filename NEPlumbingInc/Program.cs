...
// Use local file storage in Development, blob storage in Production
if (builder.Environment.IsDevelopment())
{
    builder.Services.AddScoped<IServiceImageStorageService, LocalFileServiceImageStorageService>();
}
else
{
